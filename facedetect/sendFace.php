...
$image_name = "upload/".$username;


$login = mysqli_query($mysqli,"select * from `laporan` where username='$username' and password='$password'");
...
$result = mysqli_query($mysqli, "INSERT INTO `uploadb`(id, keterangan) VALUES('$id','Gambar dengan nama $fullName berhasil di upload')");
mysqli_close($mysqli);
